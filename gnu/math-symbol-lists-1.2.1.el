...
;; 
;; 	* math-symbols-list.el: Remove spurious SPC
;; 
...
;; 
;; 	While I was there I also fixed the following: Use lexical-binding. 
;; 	Require cl-lib since it's used, and stop using `cl`. Fix namespace to
;; 	always start with "msl-". Wrap toplevel operations into a `defun` since
;; 	files in `load-path` may be loaded gratuitously by Emacs.
;; 
;; 	* packages/math-symbol-lists/math-symbol-lists.el: Update license
;; 	address.
;; 
;; 2019-05-07  Vitalie Spinu  <spinuvit@gmail.com>
;; 
...
;; 
;; 2016-02-28  Vitalie Spinu  <spinuvit@gmail.com>
;; 
;; 	Merge math-symbol-lists
;; 
;; 2015-08-31  Stefan Monnier  <monnier@iro.umontreal.ca>
;; 
;; 	* math-symbol-lists: Fix trailer; provide email address
;; 
;; 2015-08-31  Vitalie Spinu  <spinuvit@gmail.com>
;; 
