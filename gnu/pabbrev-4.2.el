...
;; 2015-02-18  Phillip Lord  <phillip.lord@newcastle.ac.uk>
;; 
;; 	Move to cl-lib.
;; 
;; 2015-02-18  Phillip Lord  <phillip.lord@newcastle.ac.uk>
...
;; 2015-02-18  Phillip Lord  <phillip.lord@newcastle.ac.uk>
;; 
;; 	Added default value for pabbrev-debug-enabled.
;; 
;; 	For some reason the default nil value had been dropped off, so revert 
;; 	this.
;; 
;; 2015-02-18  Phillip Lord  <phillip.lord@newcastle.ac.uk>
;; 
...
;; 2015-02-18  Phillip Lord  <phillip.lord@newcastle.ac.uk>
;; 
;; 	Limit files to pabbrev.el alone.
;; 
;; 2015-02-18  Phillip Lord  <phillip.lord@newcastle.ac.uk>
;; 
;; 	Add cask file.
...
;; 2015-02-18  Phillip Lord  <phillip.lord@newcastle.ac.uk>
;; 
;; 	Use define-global-minor-mode and add autoload.
;; 
;; 2014-11-07  Phillip Lord  <phillip.lord@newcastle.ac.uk>
;; 
...
;; 2014-11-06  Stefan Monnier  <monnier@iro.umontreal.ca>
;; 
;; 	* pabbrev.el: Miscellaneous cleanup based on compiler warnings.
;; 	(working-status-forms, working-status, working-dynamic-status): Move
;; 	before use.
;; 	(pabbrev-save-buffer-modified-p): Use with-silent-modifications when
;; 	available.  Be more careful about restoring state.
;; 	(pabbrev-mode-map): Initialize in the declaration.
;; 	(pabbrev-mode): Incorporate the code here instead of adding it to 
;; 	pabbrev-mode-on/off-hook.  Add autoload cookie.
;; 	(global-pabbrev-mode): Add autoload cookie.
;; 	(pabbrev-mode-on-hook, pabbrev-mode-on-hook): Leave them nil.
;; 	(pabbrev-mode-on, pabbrev-mode-off): Inline into pabbrev-mode.
;; 	(pabbrev-expand-commands, pabbrev-debug-message)
;; 	(pabbrev-window-configuration): Move before first use.
;; 	(pabbrev-insert-suggestion): Remove `end' argument; it was always equal 
;; 	to point.  Use overlay's after-string under Emacs.
;; 	(pabbrev-delete-last-suggestion): Adjust accordingly.
;; 	(pabbrev-select-mode, pabbrev-select-mode-map): Define at top level.
;; 	(pabbrev-scavenge-buffer-fast, pabbrev-scavenge-buffer): Fix debug
;; 	messages.
;; 
;; 2014-10-21  Phillip Lord  <phillip.lord@newcastle.ac.uk>
;; 
;; 	v4.1 release
;; 
...
;; 
;; 	Copyright to FSF, GPL to version 3.
;; 
;; 2014-10-18  Phillip Lord  <phillip.lord@newcastle.ac.uk>
;; 
;; 	Set version to 0 for ELPA.
;; 
;; 	ELPA will not publish anything at all if the Version is set to 0, so do
;; 	this until I am sure that I have everything in place.
;; 
;; 2014-09-19  Phillip Lord  <phillip.lord@newcastle.ac.uk>
;; 
;; 	Updated copyright date.
;; 
;; 	pabbrev was first written in 2003, from the versions archived on
;; 	archive.org.
;; 
;; 2014-09-16  Phillip Lord  <phillip.lord@newcastle.ac.uk>
;; 
;; 	Use with-current-buffer
;; 
;; 	Replaces save-excursion, set-buffer combination which produces a byte 
;; 	compile warning now.
;; 
;; 2014-09-16  Phillip Lord  <phillip.lord@newcastle.ac.uk>
;; 
;; 	set-overlays appeared twice.
;; 
;; 2014-09-16  Phillip Lord  <phillip.lord@newcastle.ac.uk>
;; 
...
;; 2014-09-16  Phillip Lord  <phillip.lord@newcastle.ac.uk>
;; 
;; 	README.md update for version 4.0
;; 
;; 2014-09-16  Phillip Lord  <phillip.lord@newcastle.ac.uk>
;; 
;; 	README.md added.
...
;; 2014-09-16  Phillip Lord  <phillip.lord@newcastle.ac.uk>
;; 
;; 	Add cider-nrepl mode to ignored.
;; 
;; 2014-09-16  Phillip Lord  <phillip.lord@newcastle.ac.uk>
;; 
...
;; 	hard-coded to tab. This commit enables changing the keybinding, but has
;; 	to add specific support for tab and return.
;; 
;; 2014-09-11  Phillip Lord  <phillip.lord@newcastle.ac.uk>
;; 
;; 	pabbrev-mode now sets inhibit-modification-hooks
;; 
;; 	This was motivated by a nasty interaction with linked-buffer but should
;; 	be general.
;; 
;; 2013-12-17  Phillip Lord  <phillip.lord@newcastle.ac.uk>
;; 
;; 	Keywords, Status added.
;; 
;; 2013-12-17  Phillip Lord  <phillip.lord@newcastle.ac.uk>
;; 
;; 	Some code re-organisation. Checks whether pulse.el can cope with
;; 	foreground pulse.
;; 
;; 2013-12-02  Phillip Lord  <phillip.lord@newcastle.ac.uk>
;; 
;; 	Initial checkin
;; 
;; 2013-09-23  Phillip Lord  <phillip.lord@newcastle.ac.uk>
;; 
;; 	Exclude nrepl mode.
;; 
;; 2013-09-23  Phillip Lord  <phillip.lord@newcastle.ac.uk>
...
;; 2013-09-23  Phillip Lord  <phillip.lord@newcastle.ac.uk>
;; 
;; 	Copes better with missing repos. Improved output.
;; 
;; 2013-09-23  Phillip Lord  <phillip.lord@newcastle.ac.uk>
;; 
;; 	Version number added. Documentation fix. Indentation fix.
;; 
;; 2013-09-23  Phillip Lord  <phillip.lord@newcastle.ac.uk>
;; 
...
;; 
;; 2013-09-21  Phillip Lord  <phillip.lord@newcastle.ac.uk>
;; 
;; 	Initial checkin.
;; 
;; 2013-07-03  Phillip Lord  <phillip.lord@newcastle.ac.uk>
;; 
;; 	Initial Checkin
;; 
;; 2013-01-12  Phillip Lord  <phillip.lord@newcastle.ac.uk>
;; 
;; 	Initial Checkin
;; 
;; 2012-10-25  Phillip Lord  <phillip.lord@newcastle.ac.uk>
;; 
;; 	Initial Checkin
;; 
;; 2012-10-25  Phillip Lord  <phillip.lord@newcastle.ac.uk>
...
;; 2012-10-25  Phillip Lord  <phillip.lord@newcastle.ac.uk>
;; 
;; 	Added support $$ pass through, which works with an unconfigured
;; 	asciidoc.
;; 
;; 2012-09-03  Phillip Lord  <phillip.lord@newcastle.ac.uk>
;; 
;; 	Prepared for Marmalade
;; 
;; 2012-08-26  phillord@cytomander	 <phillord@cytomander>
;; 
;; 	Ported from generic.el to define-derived-mode. Comment-character is now
;; 	"#" rather than fudged "# " Delimited URIs now recognised as strings 
;; 	Electric indentation added. Indentation engine improved.
;; 
;; 2012-08-14  Phillip Lord  <phillip.lord@newcastle.ac.uk>
;; 
;; 	Updated commentary
;; 
;; 2012-08-14  Phillip Lord  <phillip.lord@newcastle.ac.uk>
